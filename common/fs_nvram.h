...
/* Size of blocks in a NVRAM filesystem with backup (total size is 0x4C000 in
 * c3745) */
...
/** Align the private-config header to 4 bytes with a padding of 7/6/5/0 bytes.
 * (default, ignored) */
...
/** Use addresses relative to the the end of the filesystem magic. (default,
 * ignored) Add 8 to get the raw offset.
 */
...
#define FS_NVRAM_FORMAT_DEFAULT                                                \
  (FS_NVRAM_FLAG_NO_SCALE | FS_NVRAM_FLAG_ALIGN_4_PAD_8 |                      \
   FS_NVRAM_FLAG_ADDR_RELATIVE | FS_NVRAM_FLAGS_UNK1_0C04)

/** Filesystem format for the c2600 platform. */
#define FS_NVRAM_FORMAT_SCALE_4                                                \
  (FS_NVRAM_FLAG_SCALE_4 | FS_NVRAM_FLAG_ALIGN_4_PAD_8 |                       \
   FS_NVRAM_FLAG_ADDR_RELATIVE | FS_NVRAM_FLAGS_UNK1_0C03)

/** Filesystem format for the c3725/c3745 platforms. */
#define FS_NVRAM_FORMAT_WITH_BACKUP                                            \
  (FS_NVRAM_FLAG_NO_SCALE | FS_NVRAM_FLAG_ALIGN_4_PAD_4 |                      \
   FS_NVRAM_FLAG_ADDR_RELATIVE | FS_NVRAM_FLAGS_UNK1_0C04 |                    \
   FS_NVRAM_FLAG_WITH_BACKUP)

/** Filesystem format for the c7000 platform. */
#define FS_NVRAM_FORMAT_ABSOLUTE                                               \
  (FS_NVRAM_FLAG_NO_SCALE | FS_NVRAM_FLAG_ALIGN_4_PAD_4 |                      \
   FS_NVRAM_FLAG_ADDR_ABSOLUTE | FS_NVRAM_FLAGS_UNK1_0C04)

/** Filesystem format for the c6msfc1 platform. */
#define FS_NVRAM_FORMAT_ABSOLUTE_C6                                            \
  (FS_NVRAM_FLAG_NO_SCALE | FS_NVRAM_FLAG_ALIGN_4_PAD_4 |                      \
   FS_NVRAM_FLAG_ADDR_ABSOLUTE | FS_NVRAM_FLAGS_UNK1_0C01)

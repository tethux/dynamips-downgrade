...
int int_equal(void *i1, void *i2) { return (((int)(long)i1) == (int)(long)i2); }
...
/* Compare 2 pointers */
int ptr_equal(void *i1, void *i2) { return ((int)(i1 == i2)); }
...
static inline void hash_node_free(hash_node_t *node) { free(node); }

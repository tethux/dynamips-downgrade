 ...
 * dev_rom_access()
 */
void *dev_rom_access(cpu_gen_t *cpu, struct vdevice *dev, m_uint32_t offset,
...
int dev_rom_init(vm_instance_t *vm, char *name, m_uint64_t paddr,
                 m_uint32_t len, m_uint8_t *rom_data, ssize_t rom_data_size) {
  struct rom_data *d;

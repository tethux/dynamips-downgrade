...
int dev_dec21050_init(struct pci_bus *pci_bus, int pci_device,
  ...
  dev = pci_bridge_create_dev(pci_bus, "dec21050", PCI_VENDOR_DEC,
                              PCI_PRODUCT_DEC_21050, pci_device, 0, sec_bus,
                              NULL, NULL);
  return ((dev != NULL) ? 0 : -1);
}
...
int dev_dec21052_init(struct pci_bus *pci_bus, int pci_device,
  ...
  dev = pci_bridge_create_dev(pci_bus, "dec21052", PCI_VENDOR_DEC,
                              PCI_PRODUCT_DEC_21052, pci_device, 0, sec_bus,
                              NULL, NULL);
  return ((dev != NULL) ? 0 : -1);
}
...
int dev_dec21150_init(struct pci_bus *pci_bus, int pci_device,
  ...
  dev = pci_bridge_create_dev(pci_bus, "dec21150", PCI_VENDOR_DEC,
                              PCI_PRODUCT_DEC_21150, pci_device, 0, sec_bus,
                              NULL, NULL);
  return ((dev != NULL) ? 0 : -1);
}
...
int dev_dec21152_init(struct pci_bus *pci_bus, int pci_device,
  ...
  dev = pci_bridge_create_dev(pci_bus, "dec21152", PCI_VENDOR_DEC,
                              PCI_PRODUCT_DEC_21152, pci_device, 0, sec_bus,
                              NULL, NULL);
  return ((dev != NULL) ? 0 : -1);
}
...
int dev_dec21154_init(struct pci_bus *pci_bus, int pci_device,
  ...
  dev = pci_bridge_create_dev(pci_bus, "dec21154", PCI_VENDOR_DEC,
                              PCI_PRODUCT_DEC_21154, pci_device, 0, sec_bus,
                              NULL, NULL);
  return ((dev != NULL) ? 0 : -1);
}

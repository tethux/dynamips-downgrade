...
static inline void
dev_c3725_iofpga_net_update_irq(struct c3725_iofpga_data *d) {
...
void dev_c3725_iofpga_net_set_irq(struct c3725_iofpga_data *d, u_int slot,
                                  u_int port) {
...
void dev_c3725_iofpga_net_clear_irq(struct c3725_iofpga_data *d, u_int slot,
                                    u_int port) {
  struct net_irq_distrib *irq_dist;
 ...
 */
static void *dev_c3725_iofpga_access(cpu_gen_t *cpu, struct vdevice *dev,
...
static void dev_c3725_iofpga_shutdown(vm_instance_t *vm,

 ...
 * dev_i8254x_access()
 */
void *dev_i8254x_access(cpu_gen_t *cpu, struct vdevice *dev, m_uint32_t offset,
 ...
 */
static int dev_i8254x_receive_pkt(struct i8254x_data *d, u_char *pkt,
                                  ssize_t pkt_len) {
...
/* Handle the RX ring */
static int dev_i8254x_handle_rxring(netio_desc_t *nio, u_char *pkt,
                                    ssize_t pkt_len, struct i8254x_data *d) {
  /*
 ...
 */
static void pci_i8254x_write(cpu_gen_t *cpu, struct pci_device *dev, int reg,
                             m_uint32_t value) {
  struct i8254x_data *d = dev->priv_data;
 ...
 * dev_i8254x_init()
 */
struct i8254x_data *dev_i8254x_init(vm_instance_t *vm, char *name,
  ...
  /* Add as PCI device */
  pci_dev = pci_dev_add(pci_bus, name, I8254X_PCI_VENDOR_ID,
                        I8254X_PCI_PRODUCT_ID, pci_device, 0, irq, d, NULL,
                        pci_i8254x_read, pci_i8254x_write);

...
static rbtree_node *rbtree_node_alloc(rbtree_tree *tree, void *key,
                                      void *value) {
  rbtree_node *node;
...
_Unused static inline rbtree_node *rbtree_max(rbtree_tree *tree,
                                              rbtree_node *x) {
...
int rbtree_node_count(rbtree_tree *tree) { return (tree->node_count); }

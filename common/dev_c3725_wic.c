...
static int dev_c3725_mb_wic_get_mpsc_chan(struct cisco_card *card,
...
static int dev_c3725_mb_wic1t_init(vm_instance_t *vm, struct cisco_card *card) {
...
static int dev_c3725_mb_wic1t_shutdown(vm_instance_t *vm,
...
static int dev_c3725_mb_wic1t_set_nio(vm_instance_t *vm,
  ...
  return (dev_gt96100_mpsc_set_nio(VM_C3725(vm)->gt_data, mpsc_chan, nio));
}

/* Unbind a Network IO descriptor */
static int dev_c3725_mb_wic1t_unset_nio(vm_instance_t *vm,
                                        struct cisco_card *card,
                                        u_int port_id) {
  u_int mpsc_chan;
  ...
  return (dev_gt96100_mpsc_unset_nio(VM_C3725(vm)->gt_data, mpsc_chan));
}

/* Initialize a WIC-2T in the specified slot */
static int dev_c3725_mb_wic2t_init(vm_instance_t *vm, struct cisco_card *card) {
  struct wic_serial_data *wic_data;
  m_uint64_t phys_addr;
  u_int wic_id;
...
static int dev_c3725_mb_wic2t_shutdown(vm_instance_t *vm,
                                       struct cisco_card *card) {
  /* Remove the WIC device */
  dev_wic_serial_remove(card->drv_info);
...
/* Bind a Network IO descriptor */
static int dev_c3725_mb_wic2t_set_nio(vm_instance_t *vm,
                                      struct cisco_card *card, u_int port_id,
                                      netio_desc_t *nio) {
  u_int mpsc_chan;
...
/* Unbind a Network IO descriptor */
static int dev_c3725_mb_wic2t_unset_nio(vm_instance_t *vm,
                                        struct cisco_card *card,
                                        u_int port_id) {
  u_int mpsc_chan;
...
/* Cisco 3725 WIC-1T driver (for mainboard) */
struct cisco_card_driver dev_c3725_mb_wic1t_driver = {
    "WIC-1T",
    1,
    0,
    dev_c3725_mb_wic1t_init,
    dev_c3725_mb_wic1t_shutdown,
    NULL,
    dev_c3725_mb_wic1t_set_nio,
    dev_c3725_mb_wic1t_unset_nio,
    NULL,
};

/* Cisco 3725 WIC-2T driver (for mainboard) */
struct cisco_card_driver dev_c3725_mb_wic2t_driver = {
    "WIC-2T",
    1,
    0,
    dev_c3725_mb_wic2t_init,
    dev_c3725_mb_wic2t_shutdown,
    NULL,
    dev_c3725_mb_wic2t_set_nio,
    dev_c3725_mb_wic2t_unset_nio,
    NULL,
};

/* WIC drivers (mainbord slots) */
struct cisco_card_driver *dev_c3725_mb_wic_drivers[] = {
    &dev_c3725_mb_wic1t_driver,
    &dev_c3725_mb_wic2t_driver,
    NULL,
};

...
static int dev_c3600_nm_eth_shutdown(vm_instance_t *vm,
 ...
 */
static int dev_c3600_nm_1fe_tx_init(vm_instance_t *vm,
                                    struct cisco_card *card) {
...
static int dev_c3600_nm_16esw_shutdown(vm_instance_t *vm,
                                       struct cisco_card *card) {
...
/* Bind a Network IO descriptor */
static int dev_c3600_nm_16esw_set_nio(vm_instance_t *vm,
                                      struct cisco_card *card, u_int port_id,
                                      netio_desc_t *nio) {
...
/* Show debug info */
static int dev_c3600_nm_16esw_show_info(vm_instance_t *vm,
                                        struct cisco_card *card) {
  struct nm_16esw_data *d = card->drv_info;
...
static const struct cisco_eeprom eeprom_c3600_leopard_2fe = {
    "Leopard-2FE",
    (m_uint16_t *)eeprom_c3600_leopard_2fe_data,
 ...
 */
static int dev_c3600_leopard_2fe_init(vm_instance_t *vm,
                                      struct cisco_card *card) {
  if (card->slot_id != 0) {

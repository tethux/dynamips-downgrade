...
/* Setup a filter */
int netio_filter_setup(netio_desc_t *nio, int direction, int argc,
                       char *argv[]) {
  netio_pktfilter_t *pf;
  void **opt;
...
static int pf_capture_setup(netio_desc_t *nio, void **opt, int argc,
                            char *argv[]) {
...
static netio_pktfilter_t pf_capture_def = {
    "capture", pf_capture_setup, pf_capture_free, pf_capture_pkt_handler, NULL,
};
...
static int pf_freqdrop_setup(netio_desc_t *nio, void **opt, int argc,
                             char *argv[]) {
...
static netio_pktfilter_t pf_freqdrop_def = {
    "freq_drop", pf_freqdrop_setup, pf_freqdrop_free, pf_freqdrop_pkt_handler,
    NULL,
};

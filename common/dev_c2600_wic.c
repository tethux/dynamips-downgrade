...
static int dev_c2600_mb_wic1t_shutdown(vm_instance_t *vm,
...
static int dev_c2600_mb_wic1t_set_nio(vm_instance_t *vm,
...
static int dev_c2600_mb_wic1t_unset_nio(vm_instance_t *vm,
                                        struct cisco_card *card,
                                        u_int port_id) {
  u_int scc_chan;
...
static int dev_c2600_mb_wic2t_shutdown(vm_instance_t *vm,
                                       struct cisco_card *card) {
  /* Remove the WIC device */
  dev_wic_serial_remove(card->drv_info);
...
/* Bind a Network IO descriptor */
static int dev_c2600_mb_wic2t_set_nio(vm_instance_t *vm,
                                      struct cisco_card *card, u_int port_id,
                                      netio_desc_t *nio) {
  u_int scc_chan;
...
/* Unbind a Network IO descriptor */
static int dev_c2600_mb_wic2t_unset_nio(vm_instance_t *vm,
                                        struct cisco_card *card,
                                        u_int port_id) {
  u_int scc_chan;

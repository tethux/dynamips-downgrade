...
#define LX970A_CR_ANRESTART                                                    \
  0x0200 /* Restart Auto-Negotiation (RW=1[CFG0],SC) */
...
#define LX970A_SR_MSCFGFAULT                                                   \
  0x0080                      /* Master-Slave Configuration Fault (RO=0) */
...
#define LX970A_SR_JABBERDETECT                                                 \
  0x0002 /* Jabber Detect (10BASE-T Only) (RO=0,LH) */
...
#define LX970A_PIR1                                                            \
  0x02 /* Table 47.  PHY Identification Register 1 (Address 2) */
...
#define LX970A_PIR2                                                            \
  0x03 /* Table 48.  PHY Identification Register 2 (Address 3) */
#define LX970A_PIR2_PIN 0xFC00 /* PHY ID number (RO=000000b) */
#define LX970A_PIR2_MANMODELNUM                                                \
  0x03F0 /* Manufacturer’s model number (RO=000000b) */
#define LX970A_PIR2_MANREVNUM                                                  \
  0x000F /* Manufacturer’s revision number (RO=0011b) */
#define LX970A_PIR2_RO_MASK 0xFFFF
#define LX970A_PIR2_RW_MASK 0x0000
#define LX970A_PIR2_DEFAULT 0x0003

#define LX970A_ANAR                                                            \
  0x04 /* Table 49.  Auto Negotiation Advertisement Register (Address 4) */
...
#define LX970A_ANLPAR                                                          \
  0x05 /* Table 50.  Auto Negotiation Link Partner Ability Register (Address   \
          5) */
...
#define LX970A_ANE                                                             \
  0x06 /* Table 51.  Auto Negotiation Expansion (Address 6)                    \
        */
#define LX970A_ANE_RESERVED 0xFFE0 /* Reserved (RO=0) */
#define LX970A_ANE_PDETECTFAULT                                                \
  0x0010                        /* Parallel Detection Fault (RO=0,LH)          \
                                 */
...
#define LX970A_IER                                                             \
  0x11 /* Table 53.  Interrupt Enable Register (Address 17, Hex 11) */
...
#define LX970A_ISR                                                             \
  0x12 /* Table 54.  Interrupt Status Register (Address 18, Hex 12) */
...
#define LX970A_CFGR                                                            \
  0x13 /* Table 55.  Configuration Register (Address 19, Hex 13) */
...
#define LX970A_CFGR_LINKTEST                                                   \
  0x0100                        /* Link Test (10BASE-T) (RW=0[CFG1,MF0])       \
                                 */
#define LX970A_CFGR_LEDC 0x00C0 /* LEDC Programming bits (RW=0) */
#define LX970A_CFGR_ATXC 0x0020 /* Advance TX Clock (RW=0) */
#define LX970A_CFGR_5BS_4BN                                                    \
  0x0010 /* 5B Symbol/(100BASE-X only) 4B Nibble (RW=1[MF2]) */
#define LX970A_CFGR_SCRAMBLER                                                  \
  0x0008                         /* Scrambler (100BASE-X only) (RW=1[MF3]) */
...
#define LX970A_CFGR_LEDC_ALWAYSON                                              \
  0x00C0 /* 1 1 LEDC is continuously on (for diagnostic use) */

#define LX970A_CSR                                                             \
  0x14 /* Table 56.  Chip Status Register (Address 20, Hex 14) */
...
#define LX970A_CSR_ANCOMPLETE                                                  \
  0x0200 /* Auto-Negotiation Complete (RO=0,LH,RTOR) */

...
#define DECLARE_INSN(name)                                                     \
  static int mips64_emit_##name(cpu_mips_t *cpu, cpu_tc_t *b, mips_insn_t insn)
...
static inline void mips64_load_imm(cpu_tc_t *b, u_int hi_reg, u_int lo_reg,
                                   m_uint64_t value) {
...
void mips64_set_ra(cpu_tc_t *b, m_uint64_t ret_pc) {
  ...
  x86_mov_membase_reg(b->jit_ptr, X86_EDI, REG_OFFSET(MIPS_GPR_RA) + 4, X86_EDX,
                      4);
}
                                       ...
                                       m_uint64_t new_pc)
{
   ...
   u_char *test1,*test2,*test3,*test4,*test5;
   ...
   x86_mov_reg_membase(b->jit_ptr,X86_ESI,X86_EDI,OFFSET(cpu_mips_t,gen),4);

   /* Get JIT block info in %edx */
   x86_mov_reg_membase(b->jit_ptr,X86_EBX,
                       X86_ESI,OFFSET(cpu_gen_t,tb_virt_hash),4);
   ...
   x86_alu_reg_membase(b->jit_ptr,X86_CMP,X86_ECX,X86_EDX,
                       OFFSET(cpu_tb_t,vaddr)+4);
   test3 = b->jit_ptr;
   x86_branch8(b->jit_ptr, X86_CC_NE, 0, 1);

   /* Get pointer to the Translated Code block */
   x86_mov_reg_membase(b->jit_ptr,X86_EBX,X86_EDX,OFFSET(cpu_tb_t,tc),4);
   ...
   x86_mov_reg_membase(b->jit_ptr,X86_ESI,
                       X86_EBX,OFFSET(cpu_tc_t,jit_insn_ptr),4);
   ...
   test5 = b->jit_ptr;
   x86_branch8(b->jit_ptr, X86_CC_Z, 0, 1);
   x86_jump_reg(b->jit_ptr,X86_EAX);
...
/* Set Jump */
static void mips64_set_jump(cpu_mips_t *cpu, cpu_tc_t *b, m_uint64_t new_pc,
                            int local_jump) {
...
static void mips64_emit_memop_fast64(cpu_tc_t *b, int write_op, int opcode,
  ...
  x86_alu_reg_membase(b->jit_ptr, X86_ADC, X86_ECX, X86_EDI,
                      REG_OFFSET(base) + 4);
  ...
  x86_shift_reg_imm(b->jit_ptr, X86_SHR, X86_EAX, MTS64_HASH_SHIFT1);
  x86_shift_reg_imm(b->jit_ptr, X86_SHR, X86_ESI, MTS64_HASH_SHIFT2);
  x86_alu_reg_reg(b->jit_ptr, X86_XOR, X86_EAX, X86_ESI);

  x86_alu_reg_imm(b->jit_ptr, X86_AND, X86_EAX, MTS64_HASH_MASK);

  /* EDX = mts64_entry */
  x86_mov_reg_membase(b->jit_ptr, X86_EDX, X86_EDI,
                      OFFSET(cpu_mips_t, mts_u.mts64_cache), 4);
  ...
  x86_mov_reg_membase(b->jit_ptr, X86_EAX, X86_EDX, OFFSET(mts64_entry_t, hpa),
                      4);
...
static void mips64_emit_memop_fast32(cpu_tc_t *b, int write_op, int opcode,
                                     int base, int offset, int target,
                                     int keep_ll_bit,
                                     memop_fast_access op_handler) {
  ...
  x86_shift_reg_imm(b->jit_ptr, X86_SHR, X86_EAX, MTS32_HASH_SHIFT1);
  x86_shift_reg_imm(b->jit_ptr, X86_SHR, X86_ESI, MTS32_HASH_SHIFT2);
  x86_alu_reg_reg(b->jit_ptr, X86_XOR, X86_EAX, X86_ESI);
  ...
  /* EDX = mts32_entry */
  x86_mov_reg_membase(b->jit_ptr, X86_EDX, X86_EDI,
                      OFFSET(cpu_mips_t, mts_u.mts32_cache), 4);
  ...
  x86_mov_reg_membase(b->jit_ptr, X86_EAX, X86_EDX, OFFSET(mts32_entry_t, hpa),
                      4);
...
static void mips64_emit_memop_fast(cpu_mips_t *cpu, cpu_tc_t *b, int write_op,
...
static void mips64_emit_cp_xfr_op(cpu_tc_t *b, int rt, int rd,
                                  void (*f)(cpu_mips_t *cpu, u_int gp_reg,
                                            u_int cp0_reg)) {
  /* update pc */
  mips64_set_pc(b, b->vaddr + ((b->trans_pos - 1) << 2));
...
void mips64_check_pending_irq(cpu_tc_t *b) {
  ...
  x86_mov_reg_membase(b->jit_ptr, X86_EAX, X86_EDI,
                      OFFSET(cpu_mips_t, irq_pending), 4);
  x86_test_reg_reg(b->jit_ptr, X86_EAX, X86_EAX);
  test1 = b->jit_ptr;
  x86_branch8(b->jit_ptr, X86_CC_Z, 0, 1);
...
DECLARE_INSN(AND) {
  ...
  x86_alu_reg_membase(b->jit_ptr, X86_AND, X86_EBX, X86_EDI,
                      REG_OFFSET(rt) + 4);
...
DECLARE_INSN(BEQ) {
  ...
  x86_mov_reg_membase(b->jit_ptr, X86_EBX, X86_EDI, REG_OFFSET(rs) + 4, 4);
  x86_alu_reg_membase(b->jit_ptr, X86_CMP, X86_EBX, X86_EDI,
                      REG_OFFSET(rt) + 4);
  test2 = b->jit_ptr;
  x86_branch32(b->jit_ptr, X86_CC_NE, 0, 1);
...
DECLARE_INSN(DADDIU) {
  ...
  x86_alu_reg_membase(b->jit_ptr, X86_ADD, X86_EAX, X86_EDI, REG_OFFSET(rs));
  x86_alu_reg_membase(b->jit_ptr, X86_ADC, X86_EBX, X86_EDI,
                      REG_OFFSET(rs) + 4);
...
DECLARE_INSN(DIV) {
  ...
  x86_cdq(b->jit_ptr);
  x86_mov_membase_reg(b->jit_ptr, X86_EDI, OFFSET(cpu_mips_t, lo) + 4, X86_EDX,
                      4);
  ...
  x86_cdq(b->jit_ptr);
  x86_mov_membase_reg(b->jit_ptr, X86_EDI, OFFSET(cpu_mips_t, hi) + 4, X86_EDX,
                      4);
  return (0);
}
...
DECLARE_INSN(DSUBU) {
  ...
  x86_alu_reg_membase(b->jit_ptr, X86_SBB, X86_EBX, X86_EDI,
                      REG_OFFSET(rt) + 4);
...
DECLARE_INSN(JALR) {
  ...
  x86_mov_membase_reg(b->jit_ptr, X86_EDI, OFFSET(cpu_mips_t, ret_pc), X86_ECX,
                      4);
  ...
  /* set the new pc */
  x86_mov_reg_membase(b->jit_ptr, X86_ECX, X86_EDI, OFFSET(cpu_mips_t, ret_pc),
                      4);
  x86_mov_reg_membase(b->jit_ptr, X86_EDX, X86_EDI,
                      OFFSET(cpu_mips_t, ret_pc) + 4, 4);

  x86_mov_membase_reg(b->jit_ptr, X86_EDI, OFFSET(cpu_mips_t, pc), X86_ECX, 4);
  x86_mov_membase_reg(b->jit_ptr, X86_EDI, OFFSET(cpu_mips_t, pc) + 4, X86_EDX,
                      4);
...
DECLARE_INSN(MFHI) {
  ...
  x86_mov_reg_membase(b->jit_ptr, X86_EBX, X86_EDI, OFFSET(cpu_mips_t, hi) + 4,
                      4);
...
DECLARE_INSN(MFLO) {
  ...
  x86_mov_reg_membase(b->jit_ptr, X86_EBX, X86_EDI, OFFSET(cpu_mips_t, lo) + 4,
                      4);
...
DECLARE_INSN(MOVZ) {
   ...
   * compare gpr[rt] to 0.
   */
  x86_alu_membase_imm(b->jit_ptr, X86_CMP, X86_EDI, REG_OFFSET(rt), 0);
  test1 = b->jit_ptr;
  x86_branch8(b->jit_ptr, X86_CC_NE, 0, 1);

  x86_alu_membase_imm(b->jit_ptr, X86_CMP, X86_EDI, REG_OFFSET(rt) + 4, 0);
  test2 = b->jit_ptr;
  x86_branch32(b->jit_ptr, X86_CC_NE, 0, 1);

  /* gpr[rd] <- gpr[rs] */
  x86_mov_reg_membase(b->jit_ptr, X86_EBX, X86_EDI, REG_OFFSET(rs), 4);
  x86_mov_reg_membase(b->jit_ptr, X86_ECX, X86_EDI, REG_OFFSET(rs) + 4, 4);

  x86_mov_membase_reg(b->jit_ptr, X86_EDI, REG_OFFSET(rd), X86_EBX, 4);
  x86_mov_membase_reg(b->jit_ptr, X86_EDI, REG_OFFSET(rd), X86_ECX, 4);
...
DECLARE_INSN(MTHI) {
  ...
  x86_mov_membase_reg(b->jit_ptr, X86_EDI, OFFSET(cpu_mips_t, hi), X86_EAX, 4);
  x86_mov_membase_reg(b->jit_ptr, X86_EDI, OFFSET(cpu_mips_t, hi) + 4, X86_EBX,
                      4);
...
DECLARE_INSN(MTLO) {
  ...
  x86_mov_membase_reg(b->jit_ptr, X86_EDI, OFFSET(cpu_mips_t, lo), X86_EAX, 4);
  x86_mov_membase_reg(b->jit_ptr, X86_EDI, OFFSET(cpu_mips_t, lo) + 4, X86_EBX,
                      4);
...
DECLARE_INSN(XOR) {
  ...
  x86_alu_reg_membase(b->jit_ptr, X86_XOR, X86_EBX, X86_EDI,
                      REG_OFFSET(rt) + 4);

...
static m_uint32_t eflags_to_cr_signed[64] = {
    0x04, 0x02, 0x08, 0x02, 0x04, 0x02, 0x08, 0x02, 0x04, 0x02, 0x08,
    0x02, 0x04, 0x02, 0x08, 0x02, 0x04, 0x02, 0x08, 0x02, 0x04, 0x02,
    0x08, 0x02, 0x04, 0x02, 0x08, 0x02, 0x04, 0x02, 0x08, 0x02, 0x08,
    0x02, 0x04, 0x02, 0x08, 0x02, 0x04, 0x02, 0x08, 0x02, 0x04, 0x02,
    0x08, 0x02, 0x04, 0x02, 0x08, 0x02, 0x04, 0x02, 0x08, 0x02, 0x04,
    0x02, 0x08, 0x02, 0x04, 0x02, 0x08, 0x02, 0x04, 0x02,
};
...
static m_uint32_t eflags_to_cr_unsigned[256] = {
    ...
    ,
...
static void ppc32_set_lr(jit_op_t *iop, m_uint32_t new_lr) {
  amd64_mov_membase_imm(iop->ob_ptr, AMD64_R15, OFFSET(cpu_ppc_t, lr), new_lr,
                        4);
}
...
static void ppc32_try_direct_far_jump(cpu_ppc_t *cpu, jit_op_t *iop,
  ...
  amd64_mov_reg_membase(iop->ob_ptr, AMD64_RBX, AMD64_R15,
                        OFFSET(cpu_ppc_t, tcb_virt_hash), 8);
  amd64_mov_reg_membase(iop->ob_ptr, AMD64_RDX, AMD64_RBX,
                        ia_hash * sizeof(void *), 8);
  ...
  /* Jump to the code */
  amd64_mov_reg_membase(iop->ob_ptr, AMD64_RSI, AMD64_RDX,
                        OFFSET(ppc32_jit_tcb_t, jit_insn_ptr), 8);

  amd64_test_reg_reg(iop->ob_ptr, AMD64_RSI, AMD64_RSI);
  test3 = iop->ob_ptr;
  amd64_branch8(iop->ob_ptr, X86_CC_Z, 0, 1);

  amd64_mov_reg_membase(iop->ob_ptr, AMD64_RBX, AMD64_RSI,
                        ia_offset * sizeof(void *), 8);
...
static forced_inline void ppc32_alu_gpr(u_char **ptr, u_int op, u_int host_reg,
                                        u_int ppc_reg) {
  amd64_alu_reg_membase_size(*ptr, op, host_reg, AMD64_R15, REG_OFFSET(ppc_reg),
                             4);
}
...
static int ppc32_jit_get_tmp_hreg(cpu_ppc_t *cpu) { return (AMD64_RBX); }
...
/* Memory operation */
static void ppc32_emit_memop(cpu_ppc_t *cpu, ppc32_jit_tcb_t *b, int op,
                             int base, int offset, int target, int update) {
...
static void ppc32_emit_memop_idx(cpu_ppc_t *cpu, ppc32_jit_tcb_t *b, int op,
                                 int ra, int rb, int target, int update) {
  jit_op_t *iop;
...
static void ppc32_emit_memop_fast(cpu_ppc_t *cpu, ppc32_jit_tcb_t *b,
                                  int write_op, int opcode, int base,
  ...
  /* RCX = mts32 entry */
  amd64_mov_reg_membase(iop->ob_ptr, AMD64_RCX, AMD64_R15,
  ...
  if (write_op) {
    amd64_test_membase_imm_size(iop->ob_ptr, AMD64_RCX,
                                OFFSET(mts32_entry_t, flags),
  ...
  amd64_mov_reg_membase(iop->ob_ptr, AMD64_RBX, AMD64_RCX,
                        OFFSET(mts32_entry_t, hpa), 8);
...
void ppc32_inc_perf_counter(cpu_ppc_t *cpu) {
  ...
  amd64_inc_membase_size(iop->ob_ptr, AMD64_R15,
                         OFFSET(cpu_ppc_t, perf_counter), 4);
}
...
DECLARE_INSN(BCTR) {
  ...
  amd64_mov_reg_membase(iop->ob_ptr, hreg, AMD64_R15, OFFSET(cpu_ppc_t, ctr),
                        4);
  amd64_mov_membase_reg(iop->ob_ptr, AMD64_R15, OFFSET(cpu_ppc_t, ia), hreg, 4);
...
DECLARE_INSN(MFLR) {
  ...
  amd64_mov_reg_membase(iop->ob_ptr, hreg_rd, AMD64_R15, OFFSET(cpu_ppc_t, lr),
                        4);
...
DECLARE_INSN(MTLR) {
  ...
  amd64_mov_membase_reg(iop->ob_ptr, AMD64_R15, OFFSET(cpu_ppc_t, lr), hreg_rs,
                        4);
  return (0);
}
...
DECLARE_INSN(MFCTR) {
  ...
  amd64_mov_reg_membase(iop->ob_ptr, hreg_rd, AMD64_R15, OFFSET(cpu_ppc_t, ctr),
                        4);
  ppc32_op_emit_store_gpr(cpu, rd, hreg_rd);
...
DECLARE_INSN(MTCTR) {
  ...
  amd64_mov_membase_reg(iop->ob_ptr, AMD64_R15, OFFSET(cpu_ppc_t, ctr), hreg_rs,
                        4);
...
DECLARE_INSN(MFTBU) {
  ...
  amd64_mov_reg_membase(iop->ob_ptr, hreg_rd, AMD64_R15,
                        OFFSET(cpu_ppc_t, tb) + 4, 4);
  ppc32_op_emit_store_gpr(cpu, rd, hreg_rd);
...
DECLARE_INSN(MFTBL) {
  ...
  amd64_mov_reg_membase(iop->ob_ptr, hreg_rd, AMD64_R15, OFFSET(cpu_ppc_t, tb),
                        8);
  amd64_alu_reg_imm(iop->ob_ptr, X86_ADD, hreg_rd, PPC32_TB_INCREMENT);
  amd64_mov_membase_reg(iop->ob_ptr, AMD64_R15, OFFSET(cpu_ppc_t, tb), hreg_rd,
                        8);
...
DECLARE_INSN(ADDE) {
  ...
  amd64_alu_reg_membase_size(iop->ob_ptr, X86_ADD, hreg_t0, AMD64_R15,
                             OFFSET(cpu_ppc_t, xer_ca), 4);
  ...
  amd64_set_reg(iop->ob_ptr, X86_CC_C, hreg_t1, FALSE);
  amd64_alu_membase_reg_size(iop->ob_ptr, X86_OR, AMD64_R15,
                             OFFSET(cpu_ppc_t, xer_ca), hreg_t1, 4);
...
DECLARE_INSN(ADDIC) {
  ...
  amd64_set_membase(iop->ob_ptr, X86_CC_C, AMD64_R15, OFFSET(cpu_ppc_t, xer_ca),
                    FALSE);
...
DECLARE_INSN(ADDZE) {
  ...
  amd64_alu_reg_membase_size(iop->ob_ptr, X86_ADD, hreg_rd, AMD64_R15,
                             OFFSET(cpu_ppc_t, xer_ca), 4);
...
DECLARE_INSN(BCC) {
  ...
  amd64_test_membase_imm_size(iop->ob_ptr, AMD64_R15,
                              PPC32_CR_FIELD_OFFSET(cr_field), (1 << cr_bit),
                              4);
...
DECLARE_INSN(BCLR) {
  ...
  /* Set the return address */
  amd64_mov_reg_membase(iop->ob_ptr, hreg_t1, AMD64_R15, OFFSET(cpu_ppc_t, lr),
                        4);
  ...
  amd64_mov_membase_reg(iop->ob_ptr, AMD64_R15, OFFSET(cpu_ppc_t, ia), hreg_t1,
                        4);
  ppc32_jit_tcb_push_epilog(&iop->ob_ptr);
...
DECLARE_INSN(CRAND) {
  ...
  /* test $ba bit */
  amd64_test_membase_imm(iop->ob_ptr, AMD64_R15,
  ...
  amd64_alu_membase_imm_size(iop->ob_ptr, X86_AND, AMD64_R15,
...
DECLARE_INSN(MCRF) {
  ...
  amd64_mov_reg_membase(iop->ob_ptr, hreg_t0, AMD64_R15,
                        PPC32_CR_FIELD_OFFSET(rs), 4);
...
DECLARE_INSN(MFMSR) {
  ...
  amd64_mov_reg_membase(iop->ob_ptr, hreg_rd, AMD64_R15, OFFSET(cpu_ppc_t, msr),
                        4);
  ppc32_op_emit_store_gpr(cpu, rd, hreg_rd);

...
void mips64_exec_create_ilt(void) {
  ...
  for (i = 0, count = 0; mips64_exec_tags[i].exec; i++) {
    crc32 = crc32_compute(~crc32, (m_uint8_t *)&mips64_exec_tags[i].mask,
                          sizeof(mips64_exec_tags[i].mask));
    crc32 = crc32_compute(~crc32, (m_uint8_t *)&mips64_exec_tags[i].value,
                          sizeof(mips64_exec_tags[i].value));
    count++;
  }

  ilt = ilt_create(
      "mips64e", crc32, count, (ilt_get_insn_cbk_t)mips64_exec_get_insn,
...
void mips64_dump_stats(cpu_mips_t *cpu) {
  ...
  for (i = 0; mips64_exec_tags[i].exec; i++)
    printf("  * %-10s : %10llu\n", mips64_exec_tags[i].name,
           mips64_exec_tags[i].count);
...
int mips64_dump_insn(char *buffer, size_t buf_size, size_t insn_name_size,
  ...
  case 2: /* load/store instructions */
    ...
    snprintf(buffer, buf_size, "%8.8x  %s %s,%d(%s)", instruction, insn_name,
             mips64_gpr_reg_names[rt], offset, mips64_gpr_reg_names[base]);
    break;
  ...
  case 3: /* GPR[rd] = GPR[rs] op GPR[rt] */
    ...
    snprintf(buffer, buf_size, "%8.8x  %s %s,%s,%s", instruction, insn_name,
             mips64_gpr_reg_names[rd], mips64_gpr_reg_names[rs],
  ...
  case 4: /* GPR[rd] = GPR[rt] op GPR[rs] */
    ...
    rd = bits(instruction, 11, 15);
    snprintf(buffer, buf_size, "%8.8x  %s %s,%s,%s", instruction, insn_name,
             mips64_gpr_reg_names[rd], mips64_gpr_reg_names[rt],
  ...
  case 5: /* GPR[rt] = GPR[rs] op immediate (hex) */
    ...
    snprintf(buffer, buf_size, "%8.8x  %s %s,%s,0x%x", instruction, insn_name,
             mips64_gpr_reg_names[rt], mips64_gpr_reg_names[rs], imm);
    break;
  ...
  case 6: /* GPR[rt] = GPR[rs] op immediate (dec) */
    ...
    rt = bits(instruction, 16, 20);
    imm = bits(instruction, 0, 15);
    snprintf(buffer, buf_size, "%8.8x  %s %s,%s,%d", instruction, insn_name,
  ...
  case 7: /* GPR[rd] = GPR[rt] op sa */
    ...
    snprintf(buffer, buf_size, "%8.8x  %s %s,%s,%d", instruction, insn_name,
             mips64_gpr_reg_names[rd], mips64_gpr_reg_names[rt], sa);
    break;
  ...
  case 8: /* Branch with: GPR[rs] / GPR[rt] / offset */
    ...
    snprintf(buffer, buf_size, "%8.8x  %s %s,%s,0x%llx", instruction, insn_name,
             mips64_gpr_reg_names[rs], mips64_gpr_reg_names[rt], new_pc);
    break;
  ...
  case 9: /* Branch with: GPR[rs] / offset */
    ...
    offset = bits(instruction, 0, 15);
    new_pc = (pc + 4) + sign_extend(offset << 2, 18);
    snprintf(buffer, buf_size, "%8.8x  %s %s,0x%llx", instruction, insn_name,
             mips64_gpr_reg_names[rs], new_pc);
    break;

  case 10: /* Branch with: offset */
    offset = bits(instruction, 0, 15);
    new_pc = (pc + 4) + sign_extend(offset << 2, 18);
    snprintf(buffer, buf_size, "%8.8x  %s 0x%llx", instruction, insn_name,
             new_pc);
    break;
  ...
  case 13: /* op GPR[rs] */
    rs = bits(instruction, 21, 25);
    snprintf(buffer, buf_size, "%8.8x  %s %s", instruction, insn_name,
             mips64_gpr_reg_names[rs]);
    break;
  ...
  case 14: /* op GPR[rd] */
    rd = bits(instruction, 11, 15);
    snprintf(buffer, buf_size, "%8.8x  %s %s", instruction, insn_name,
             mips64_gpr_reg_names[rd]);
    break;

  case 15: /* op GPR[rd], GPR[rs] */
    rs = bits(instruction, 21, 25);
    rd = bits(instruction, 11, 15);
    snprintf(buffer, buf_size, "%8.8x  %s %s,%s", instruction, insn_name,
             mips64_gpr_reg_names[rd], mips64_gpr_reg_names[rs]);
    break;
  ...
  case 16: /* op GPR[rt], imm */
    rt = bits(instruction, 16, 20);
    imm = bits(instruction, 0, 15);
    snprintf(buffer, buf_size, "%8.8x  %s %s,0x%x", instruction, insn_name,
             mips64_gpr_reg_names[rt], imm);
    break;
  ...
  case 18: /* op GPR[rt], CP0[rd] */
    ...
    rd = bits(instruction, 11, 15);
    snprintf(buffer, buf_size, "%8.8x  %s %s,%s", instruction, insn_name,
             mips64_gpr_reg_names[rt], mips64_cp0_reg_names[rd]);
    break;

  case 19: /* op GPR[rt], $rd */
    rt = bits(instruction, 16, 20);
    rd = bits(instruction, 11, 15);
    snprintf(buffer, buf_size, "%8.8x  %s %s,$%d", instruction, insn_name,
             mips64_gpr_reg_names[rt], rd);
    break;
  ...
  default:
    snprintf(buffer, buf_size, "%8.8x  %s (TO DEFINE - %d)", instruction,
             insn_name, tag->instr_type);
    return (-1);
  }
...
void *mips64_exec_run_cpu(cpu_gen_t *gen) {
  ...
  if (pthread_create(&timer_irq_thread, NULL, (void *)mips64_timer_irq_run,
                     cpu)) {
...
/* NOP */
static int mips64_exec_NOP(cpu_mips_t *cpu, mips_insn_t insn) { return (0); }
...
/* PREF */
static int mips64_exec_PREF(cpu_mips_t *cpu, mips_insn_t insn) { return (0); }

/* PREFI */
static int mips64_exec_PREFI(cpu_mips_t *cpu, mips_insn_t insn) { return (0); }
...
/* SYNC */
static int mips64_exec_SYNC(cpu_mips_t *cpu, mips_insn_t insn) { return (0); }

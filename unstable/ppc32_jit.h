...
static inline void ppc32_jit_tcb_set_target_bit(ppc32_jit_tcb_t *b,
                                                m_uint32_t ia) {
  int index, pos;
...
static inline int ppc32_jit_tcb_get_target_bit(ppc32_jit_tcb_t *b,
                                               m_uint32_t ia) {
  int index, pos;
...
static forced_inline u_char *ppc32_jit_tcb_get_host_ptr(ppc32_jit_tcb_t *tcb,
                                                        m_uint32_t vaddr) {
  m_uint32_t offset;
...
static forced_inline int ppc32_jit_tcb_local_addr(ppc32_jit_tcb_t *tcb,
                                                  m_uint32_t vaddr,
                                                  u_char **jit_addr) {
...
static forced_inline int ppc32_jit_tcb_match(cpu_ppc_t *cpu,
                                             ppc32_jit_tcb_t *tcb) {
  m_uint32_t vpage;
...
/* EMIT_LOAD_GPR */
static inline void ppc32_op_emit_load_gpr(cpu_ppc_t *cpu, int host_reg,
                                          int ppc_reg) {
...
/* EMIT_STORE_GPR */
static inline void ppc32_op_emit_store_gpr(cpu_ppc_t *cpu, int ppc_reg,
                                           int host_reg) {
...
/* EMIT_UPDATE_FLAGS */
static inline void ppc32_op_emit_update_flags(cpu_ppc_t *cpu, int field,
                                              int is_signed) {
...
/* EMIT_BRANCH_TARGET */
static inline void
ppc32_op_emit_branch_target(cpu_ppc_t *cpu, ppc32_jit_tcb_t *b, m_uint32_t ia) {
...
static inline void ppc32_op_emit_set_host_reg_imm32(cpu_ppc_t *cpu, int reg,
                                                    m_uint32_t val) {

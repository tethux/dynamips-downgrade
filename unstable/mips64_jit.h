...
static forced_inline u_char *mips64_jit_tc_get_host_ptr(cpu_tc_t *tc,
                                                        m_uint64_t vaddr) {
  m_uint32_t offset;
...
mips64_jit_tcb_local_addr(cpu_tc_t *tc, m_uint64_t vaddr, u_char **jit_addr) {
...
static inline cpu_tb_t *mips64_jit_find_by_phys_page(cpu_mips_t *cpu,

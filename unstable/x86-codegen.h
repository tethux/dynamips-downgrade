...
static const unsigned char x86_cc_unsigned_map[X86_NCC] = {
    0x74, /* eq  */
    0x75, /* ne  */
    0x72, /* lt  */
    0x76, /* le  */
...
static const unsigned char x86_cc_signed_map[X86_NCC] = {
    0x74, /* eq  */
    0x75, /* ne  */
    0x7c, /* lt  */
    0x7e, /* le  */
...
#define X86_CALLER_REGS                                                        \
  ((1 << X86_EBX) | (1 << X86_EBP) | (1 << X86_ESI) | (1 << X86_EDI))
#define X86_BYTE_REGS                                                          \
  ((1 << X86_EAX) | (1 << X86_ECX) | (1 << X86_EDX) | (1 << X86_EBX))

#define X86_IS_SCRATCH(reg)                                                    \
  (X86_CALLER_REGS & (1 << (reg))) /* X86_EAX, X86_ECX, or X86_EDX */
#define X86_IS_CALLEE(reg)                                                     \
  (X86_CALLEE_REGS & (1 << (reg))) /* X86_ESI, X86_EDI, X86_EBX, or X86_EBP */
...
#define x86_address_byte(inst, m, o, r)                                        \
  do {                                                                         \
...
#define x86_imm_emit16(inst, imm)                                              \
  do {                                                                         \
    *(short *)(inst) = (imm);                                                  \
    (inst) += 2;                                                               \
  } while (0)
#define x86_imm_emit8(inst, imm)                                               \
  do {                                                                         \
    *(inst) = (unsigned char)((imm) & 0xff);                                   \
    ++(inst);                                                                  \
  } while (0)
#define x86_is_imm8(imm) (((int)(imm) >= -128 && (int)(imm) <= 127))
#define x86_is_imm16(imm)                                                      \
  (((int)(imm) >= -(1 << 16) && (int)(imm) <= ((1 << 16) - 1)))

#define x86_reg_emit(inst, r, regno)                                           \
  do {                                                                         \
    x86_address_byte((inst), 3, (r), (regno));                                 \
  } while (0)
#define x86_reg8_emit(inst, r, regno, is_rh, is_rnoh)                          \
  do {                                                                         \
    x86_address_byte((inst), 3, (is_rh) ? ((r) | 4) : (r),                     \
                     (is_rnoh) ? ((regno) | 4) : (regno));                     \
  } while (0)
#define x86_regp_emit(inst, r, regno)                                          \
  do {                                                                         \
    x86_address_byte((inst), 0, (r), (regno));                                 \
  } while (0)
#define x86_mem_emit(inst, r, disp)                                            \
  do {                                                                         \
...
#define x86_stosb(inst)                                                        \
  do {                                                                         \
    *(inst)++ = (unsigned char)0xaa;                                           \
  } while (0)
#define x86_stosl(inst)                                                        \
  do {                                                                         \
    *(inst)++ = (unsigned char)0xab;                                           \
  } while (0)
#define x86_stosd(inst) x86_stosl((inst))
#define x86_movsb(inst)                                                        \
  do {                                                                         \
    *(inst)++ = (unsigned char)0xa4;                                           \
  } while (0)
#define x86_movsl(inst)                                                        \
  do {                                                                         \
...
#define x86_inc_reg(inst, reg)                                                 \
  do {                                                                         \
    *(inst)++ = (unsigned char)0x40 + (reg);                                   \
  } while (0)
...
#define x86_dec_reg(inst, reg)                                                 \
  do {                                                                         \
    *(inst)++ = (unsigned char)0x48 + (reg);                                   \
  } while (0)
  ...
  do {                                                                         \
    ...
    case 1:                                                                    \
      *(inst)++ = (unsigned char)0x88;                                         \
      break;                                                                   \
    case 2:                                                                    \
      *(inst)++ = (unsigned char)0x66; /* fall through */                      \
    case 4:                                                                    \
...
#define x86_widen_memindex(inst, dreg, basereg, disp, indexreg, shift,         \
                           is_signed, is_half)                                 \
  do {                                                                         \
    unsigned char op = 0xb6;                                                   \
    *(inst)++ = (unsigned char)0x0f;                                           \
...
#define x86_pushad(inst)                                                       \
  do {                                                                         \
    *(inst)++ = (unsigned char)0x60;                                           \
  } while (0)
#define x86_pushfd(inst)                                                       \
  do {                                                                         \
    *(inst)++ = (unsigned char)0x9c;                                           \
  } while (0)
#define x86_popad(inst)                                                        \
  do {                                                                         \
    *(inst)++ = (unsigned char)0x61;                                           \
  } while (0)
#define x86_popfd(inst)                                                        \
  do {                                                                         \
...
#define x86_fsin(inst)                                                         \
  do {                                                                         \
    *(inst)++ = (unsigned char)0xd9;                                           \
    *(inst)++ = (unsigned char)0xfe;                                           \
  } while (0)
#define x86_fcos(inst)                                                         \
  do {                                                                         \
    *(inst)++ = (unsigned char)0xd9;                                           \
    *(inst)++ = (unsigned char)0xff;                                           \
  } while (0)
#define x86_fabs(inst)                                                         \
  do {                                                                         \
    *(inst)++ = (unsigned char)0xd9;                                           \
    *(inst)++ = (unsigned char)0xe1;                                           \
  } while (0)
#define x86_ftst(inst)                                                         \
  do {                                                                         \
    *(inst)++ = (unsigned char)0xd9;                                           \
    *(inst)++ = (unsigned char)0xe4;                                           \
  } while (0)
#define x86_fxam(inst)                                                         \
  do {                                                                         \
    *(inst)++ = (unsigned char)0xd9;                                           \
    *(inst)++ = (unsigned char)0xe5;                                           \
  } while (0)
#define x86_fpatan(inst)                                                       \
  do {                                                                         \
    *(inst)++ = (unsigned char)0xd9;                                           \
    *(inst)++ = (unsigned char)0xf3;                                           \
  } while (0)
#define x86_fprem(inst)                                                        \
  do {                                                                         \
    *(inst)++ = (unsigned char)0xd9;                                           \
    *(inst)++ = (unsigned char)0xf8;                                           \
  } while (0)
#define x86_fprem1(inst)                                                       \
  do {                                                                         \
    *(inst)++ = (unsigned char)0xd9;                                           \
    *(inst)++ = (unsigned char)0xf5;                                           \
  } while (0)
#define x86_frndint(inst)                                                      \
  do {                                                                         \
    *(inst)++ = (unsigned char)0xd9;                                           \
    *(inst)++ = (unsigned char)0xfc;                                           \
  } while (0)
#define x86_fsqrt(inst)                                                        \
  do {                                                                         \
    *(inst)++ = (unsigned char)0xd9;                                           \
    *(inst)++ = (unsigned char)0xfa;                                           \
  } while (0)
#define x86_fptan(inst)                                                        \
  do {                                                                         \
    *(inst)++ = (unsigned char)0xd9;                                           \

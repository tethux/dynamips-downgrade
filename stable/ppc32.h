...
#define PPC32_PVR_MPC8xx                                                       \
  0x00500000 /* PowerPC MPC 8xx cores (aka PowerQUICC)                         \
              */
#define PPC32_PVR_MPC860                                                       \
  (PPC32_PVR_MPC8xx | 0x0202) /* assumed, because dev_mpc860 is being used */
...
typedef void (*ppc_memop_fn)(cpu_ppc_t *cpu, m_uint32_t vaddr, u_int reg);
...
struct cpu_ppc {
  ...
  mts32_entry_t *(*mts_slow_lookup)(cpu_ppc_t *cpu, m_uint32_t vaddr, u_int cid,
                                    u_int op_code, u_int op_size, u_int op_type,
                                    m_uint64_t *data, mts32_entry_t *alt_entry);

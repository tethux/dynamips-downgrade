...
typedef void (*mips_memop_fn)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg);
...
struct cpu_mips {
  ...
  int (*translate)(cpu_mips_t *cpu, m_uint64_t vaddr, m_uint32_t *phys_page);
  ...
  void (*mts_map)(cpu_mips_t *cpu, m_uint64_t vaddr, m_uint64_t paddr,

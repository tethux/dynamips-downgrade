  ...
  for (count = 0, i = 0; i < MTS_NAME_UP(HASH_SIZE); i++) {
    ...
    if (!(entry->gvpa & MTS_INV_ENTRY_MASK)) {
      printf("    %4u: vaddr=0x%8.8llx, paddr=0x%8.8llx, hpa=%p\n", i,
             (m_uint64_t)entry->gvpa, (m_uint64_t)entry->gppa,
             (void *)entry->hpa);
      count++;
    }
  }
 ...
 */
static no_inline MTS_ENTRY *MTS_PROTO(map)(cpu_mips_t *cpu, u_int op_type,
  ...
  if (dev->flags & VDEVICE_FLAG_SPARSE) {
    host_ptr =
        dev_sparse_get_host_addr(cpu->vm, dev, map->paddr, op_type, &cow);
...
MTS_PROTO(lb)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(lbu)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
/* LH: Load Half-Word */
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(lh)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(lhu)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
/* LW: Load Word */
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(lw)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(lwu)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
/* LD: Load Double-Word */
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(ld)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
/* SB: Store Byte */
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(sb)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
/* SH: Store Half-Word */
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(sh)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
/* SW: Store Word */
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(sw)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(sd)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(ldc1)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
/* LWL: Load Word Left */
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(lwl)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
...
/* LWR: Load Word Right */
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(lwr)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t r_mask, naddr;
  m_uint64_t data;
  u_int m_shift;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(ldl)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t r_mask, naddr;
  m_uint64_t data;
  u_int m_shift;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(ldr)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t r_mask, naddr;
  m_uint64_t data;
  u_int m_shift;
  void *haddr;
...
/* SWL: Store Word Left */
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(swl)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
...
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(swr)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t d_mask, naddr;
  m_uint64_t data;
  u_int r_shift;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(sdl)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t d_mask, naddr;
  m_uint64_t data;
  u_int r_shift;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(sdr)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t d_mask, naddr;
  m_uint64_t data;
  u_int r_shift;
  void *haddr;
...
/* LL: Load Linked */
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(ll)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(sc)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(sdc1)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
MTS_PROTO(cache)(cpu_mips_t *cpu, m_uint64_t vaddr, u_int op) {
  mips64_jit_tcb_t *block;
  m_uint32_t pc_hash;

#if DEBUG_CACHE
  cpu_log(cpu->gen, "MTS",
          "CACHE: PC=0x%llx, vaddr=0x%llx, cache=%u, code=%u\n", cpu->pc, vaddr,
          op & 0x3, op >> 2);
#endif

...
void ppc32_access_special(cpu_ppc_t *cpu, m_uint32_t vaddr, u_int cid,
...
#if DEBUG_MTS_ACC_T
      cpu_log(cpu->gen, "MTS",
              "MMU exception for address 0x%8.8x at ia=0x%8.8x "
              "(%s access, size=%u)\n",
              vaddr, cpu->ia, (op_type == MTS_READ) ? "read" : "write",
              op_size);
  ...
  case MTS_ACC_U:
    ...
    if (cpu->gen->undef_mem_handler != NULL) {
      if (cpu->gen->undef_mem_handler(cpu->gen, (m_uint64_t)vaddr, op_size,
                                      op_type, data))
        return;
    }
    ...
    if (op_type == MTS_READ)
      cpu_log(cpu->gen, "MTS",
              "read  access to undefined address 0x%8.8x at "
              "ia=0x%8.8x (size=%u)\n",
              vaddr, cpu->ia, op_size);
    else
      cpu_log(cpu->gen, "MTS",
              "write access to undefined address 0x%8.8x at "
...
pte_lookup_done:
  ...
  paddr |= ((m_uint64_t)(pte2 & PPC32_PTEL_XPN_MASK))
           << (33 - PPC32_PTEL_XPN_SHIFT);
  paddr |= ((m_uint64_t)(pte2 & PPC32_PTEL_X_MASK))
           << (32 - PPC32_PTEL_X_SHIFT);
...
static void *ppc32_mem_lookup(cpu_ppc_t *cpu, m_uint32_t vaddr, u_int cid) {
  m_uint64_t data;
  return (
      ppc32_mem_access(cpu, vaddr, cid, PPC_MEMOP_LOOKUP, 4, MTS_READ, &data));
}
...
/* Map a page */
int ppc32_map_page(cpu_ppc_t *cpu, u_int vsid, m_uint32_t vaddr,
                   m_uint64_t paddr, u_int wimg, u_int pp) {
...
free_pte_found:
  ...
  *(m_uint32_t *)pte_haddr = htovm32(tmp);
  ...
  tmp |= ((m_uint32_t)(paddr >> (33 - PPC32_PTEL_XPN_SHIFT))) &
         PPC32_PTEL_XPN_MASK;
...
/* Map a memory zone */
int ppc32_map_zone(cpu_ppc_t *cpu, u_int vsid, m_uint32_t vaddr,
                   m_uint64_t paddr, m_uint32_t size, u_int wimg, u_int pp) {
  while (size > 0) {
...
ppc32_lbz(cpu_ppc_t *cpu, m_uint32_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
ppc32_lhz(cpu_ppc_t *cpu, m_uint32_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
/* LWZ: Load Word Zero */
__attribute__((force_align_arg_pointer)) void
ppc32_lwz(cpu_ppc_t *cpu, m_uint32_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
ppc32_lwbr(cpu_ppc_t *cpu, m_uint32_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
ppc32_lha(cpu_ppc_t *cpu, m_uint32_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
/* STB: Store Byte */
__attribute__((force_align_arg_pointer)) void
ppc32_stb(cpu_ppc_t *cpu, m_uint32_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
/* STH: Store Half-Word */
__attribute__((force_align_arg_pointer)) void
ppc32_sth(cpu_ppc_t *cpu, m_uint32_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
/* STW: Store Word */
__attribute__((force_align_arg_pointer)) void
ppc32_stw(cpu_ppc_t *cpu, m_uint32_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
ppc32_stwbr(cpu_ppc_t *cpu, m_uint32_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
ppc32_lsw(cpu_ppc_t *cpu, m_uint32_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
ppc32_stsw(cpu_ppc_t *cpu, m_uint32_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
ppc32_lfd(cpu_ppc_t *cpu, m_uint32_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
ppc32_stfd(cpu_ppc_t *cpu, m_uint32_t vaddr, u_int reg) {
  m_uint64_t data;
  void *haddr;
...
__attribute__((force_align_arg_pointer)) void
ppc32_icbi(cpu_ppc_t *cpu, m_uint32_t vaddr, u_int op) {
  ppc32_jit_tcb_t *block;
  m_uint32_t phys_page;

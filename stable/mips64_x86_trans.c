...
static inline void mips64_load_imm(mips64_jit_tcb_t *b, u_int hi_reg,
                                   u_int lo_reg, m_uint64_t value) {
...
static void mips64_try_direct_far_jump(cpu_mips_t *cpu, mips64_jit_tcb_t *b,
  ...
  x86_mov_reg_membase(b->jit_ptr, X86_EBX, X86_EDI,
                      OFFSET(cpu_mips_t, exec_blk_map), 4);
  x86_mov_reg_membase(b->jit_ptr, X86_EDX, X86_EBX, pc_hash * sizeof(void *),
                      4);
  ...
  /* Jump to the code */
  x86_mov_reg_membase(b->jit_ptr, X86_ESI, X86_EDX,
                      OFFSET(mips64_jit_tcb_t, jit_insn_ptr), 4);
  x86_mov_reg_membase(b->jit_ptr, X86_EBX, X86_ESI, pc_offset * sizeof(void *),
                      4);
...
/* Basic C call */
static forced_inline void mips64_emit_basic_c_call(mips64_jit_tcb_t *b,
                                                   void *f) {
...
static void mips64_emit_cp_xfr_op(mips64_jit_tcb_t *b, int rt, int rd,

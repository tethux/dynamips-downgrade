...
static forced_inline u_char *mips64_jit_tcb_get_host_ptr(mips64_jit_tcb_t *b,
                                                         m_uint64_t vaddr) {
  m_uint32_t offset;
...
static forced_inline int mips64_jit_tcb_local_addr(mips64_jit_tcb_t *block,
                                                   m_uint64_t vaddr,
                                                   u_char **jit_addr) {
...
static forced_inline int mips64_jit_tcb_match(cpu_mips_t *cpu,
